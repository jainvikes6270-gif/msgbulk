...
Then open **Actions → Build Signed Play AAB → Run workflow**. When the job is green, download the `LATHAEPS-SMART-Play-AAB-v3.23.33` artifact and unzip it. Upload the `.aab` file to Play Console.
...
4. Upload `LATHAEPS_SMART_v3.23.33_Play_Signed.aab`.
