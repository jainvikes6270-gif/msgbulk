...
public class LedgerScheduleReceiver extends BroadcastReceiver {
    ...
    @Override public void onReceive(Context context,Intent intent){
        ...
        long scheduledAt=app.getLong(MainActivity.LEDGER_SCHEDULE_AT,System.currentTimeMillis());String repeat=app.getString(MainActivity.LEDGER_SCHEDULE_REPEAT,"Weekly");
        ...
        try{
            ...
            AutoReplyNotificationService.prepareLedgerBatchQueue(context,files,phones,names);showScheduledNotification(context,files.size(),next,repeat);
